...
public class levelnegative
{
	
	public static void main(String[] args) throws Exception //分正面(步驟4)
	{
		String fileName = "negative6/";//命名根目錄下的資料夾的名稱
	     String[] filename;			  
						 		...
						 		{
						 			{
										...
										FileReader fr; //檔案寫入
										fr = new FileReader("negative6/"+filename[i]); //檔案寫入綁定文件
										...
										FileWriter fw2; //檔案寫出
										fw2 = new FileWriter("levelnegative/"+i+"."+"level5."+filename[i]); //檔案寫出綁定文件
										BufferedWriter bw2 = new BufferedWriter(fw2);
										
										FileWriter fw3; //檔案寫出
										fw3 = new FileWriter("levelnegative/"+i+"."+"level4."+filename[i]); //檔案寫出綁定文件
										BufferedWriter bw3 = new BufferedWriter(fw3);
										
										FileWriter fw4; //檔案寫出
										fw4 = new FileWriter("levelnegative/"+i+"."+"level3."+filename[i]); //檔案寫出綁定文件
										BufferedWriter bw4 = new BufferedWriter(fw4);
										
										FileWriter fw5; //檔案寫出
										fw5 = new FileWriter("levelnegative/"+i+"."+"level2."+filename[i]); //檔案寫出綁定文件
										BufferedWriter bw5 = new BufferedWriter(fw5);
										
										FileWriter fw6; //檔案寫出
										fw6 = new FileWriter("levelnegative/"+i+"."+"level1."+filename[i]); //檔案寫出綁定文件
